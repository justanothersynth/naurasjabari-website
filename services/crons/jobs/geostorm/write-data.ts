import type { OrpcContext, GeostormOrpcInput } from '@package/types'
import { generateInternalJWT } from '@package/utils'
import { createEntry } from '@service/api/lib/geostorm'
